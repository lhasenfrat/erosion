...
public class CustomWaterManager : MonoBehaviour
{
    ...
    CustomMeshGenerator meshGenerator;
    ...
    void Start()
    {
        meshGenerator = gameObject.GetComponent<CustomMeshGenerator>();
    ...
    public void produceWaterExample()
    {
        StartCoroutine(produceWaterCoroutine());

    }
    public IEnumerator produceWaterCoroutine()
    {
        Vector3 middlePoint = new Vector3(75,0,75) ;
        Vector3 lastpoint = meshGenerator.GetVertice(middlePoint);
